...
from vits_train import attentions, commons, modules, monotonic_align
from vits_train.commons import get_padding, init_weights
...
def setup_optimizer(config: TrainingConfig, model) -> torch.optim.AdamW:
